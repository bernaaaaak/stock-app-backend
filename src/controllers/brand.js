...
module.exports = {
    ...
    update: async (req, res) => {
        ...
        */
        ...
        // Mevcut brand resimlerini getir:
        const brand = await Brand.findOne({ _id: req.params.id }, { _id: 0, images: 1 })
        // brand.images
        
        for (let file of req.files) {
            // Mevcut brand resimlerine ekle:
            // brand.images.push(file.filename)
            brand.images.push('/uploads/' + file.filename)
        }
        // Brand resimlerini req.body'ye aktar:
        req.body.images = brand.images
